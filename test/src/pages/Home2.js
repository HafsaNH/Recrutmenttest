                                ...
                                <div className="testimonial-top">
                                    <div className="testimonial-avatar">
                                        <div className="testimonial-img">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/finance-hover.png" alt="testimonial-img" />
                                        </div>
                                    </div>
        ...
        <div className="ttm-list-li-content">Innovative methods to connect you with the most suitable candidates in the Moroccan job market.</div>
                        ...
                        <div className="col-lg-6 col-md-9 col-sm-10 col-12 mx-auto">
                            <div className="mr-40 ml-20 pb-60 pt-lg-50">
                                <div className="d-flex justify-content-between" style={{ backgroundImage: 'url(https://themetechmount.com/react/hireco/images/single-img-02.png)' , backgroundSize: 'cover' }}>
                                    <div className="pt-20 pr-20 bg-theme-WhiteColor ml_20 mb_60 mt-200">
                                        <img src="https://themetechmount.com/react/hireco/images/single-img-01.png" className="img-fluid" alt="bgimage" />
                                    </div>
        ...
        <div className="row row-equal-height mb_10">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>We build the workforce for your organization, business, or industry with top talent.</p>
                        </div>
                    </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>Specializing in finding and placing top executives and personnel for your company.</p>
                        </div>
                    </div>
                </div>{/* featured-icon-box end */}
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>Our tailored search services ensure that your future-focused roles are filled with the best candidates.</p>
                        </div>
                    </div>
                </div>{/* featured-icon-box end */}
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>Accelerating innovation with strategic hires that drive your organization forward.</p>
                        </div>
                    </div>
                </div>{/* featured-icon-box end */}
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>Providing skilled personnel across various fields to meet your project needs.</p>
                        </div>
                    </div>
                </div>{/* featured-icon-box end */}
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                    ...
                    <div className="featured-content">
                        <div className="featured-desc">
                            <p>Offering a range of services including design, fabrication, and commissioning tailored to your needs.</p>
                        </div>
                    </div>
...
{/* features-section end */}
           ...
           {/* services-section */}
<section className="ttm-row services-section bg-img3 clearfix" style={{ backgroundImage: 'url("https://themetechmount.com/react/hireco/images/client-01.png")' }}>
    <div className="container">
        {/* row */}
        <div className="row">
            <div className="col-lg-12">
                ...
                <div className="section-title title-style-center_text">
                    <div className="title-header">
                        ...
                        <h2 className="title">Our Reach Across the Kingdom</h2>
                    </div>
                </div>{/* section title end */}
            </div>
        </div>{/* row end */}
        ...
        <Slider className="row slick_slider mb_10 slick-arrows-style1" {...slick_slider} slidesToShow={4} arrows={true}>
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                    <div className="featured-content">
                        ...
                        <div className="featured-desc">
                            <p>The economic heart of Morocco, where business opportunities thrive.</p>
                        </div>
                    </div>
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                    <div className="featured-content">
                        ...
                        <div className="featured-desc">
                            <p>The capital city, rich in history and cultural heritage.</p>
                        </div>
                    </div>
                </div>{/* featured-imagebox end */}
            </div>
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                    <div className="featured-content">
                        <div className="featured-title">
                            <h3><a href={process.env.PUBLIC_URL + '/'}>Tangier</a></h3>
                        </div>
                        <div className="featured-desc">
                            <p>Where the Mediterranean meets the Atlantic, a gateway to Africa.</p>
                        </div>
                    </div>
                </div>{/* featured-imagebox end */}
            </div>
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                    <div className="featured-content">
                        <div className="featured-title">
                            <h3><a href={process.env.PUBLIC_URL + '/'}>Fez</a></h3>
                        </div>
                        <div className="featured-desc">
                            <p>The spiritual heart of Morocco, home to the oldest university in the world.</p>
                        </div>
                    </div>
                </div>{/* featured-imagebox end */}
            </div>
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                    <div className="featured-content">
                        ...
                        <div className="featured-desc">
                            <p>A coastal city known for its beaches and resort life.</p>
                        </div>
                    </div>
                </div>{/* featured-imagebox end */}
            </div>
...
{/* services-section end */}
                        ...
                        <div className="col-lg-8">
                                ...
                                <div className="col-sm-4">
                                    <div className="client-box">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-01.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="client-box">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-02.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="client-box">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-03.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row g-0 ttm-vertical_sep">
                                <div className="col-sm-4">
                                    <div className="client-box">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-04.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="client-box">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-05.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className="client-box mb-0">
                                        <div className="client-thumbnail">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/client/client-06.png" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {/* fid-section */}
            <section className="ttm-row fid-section bg-img4 bg-theme-DarkColor ttm-bg ttm-bgimage-yes text-theme-WhiteColor clearfix" style={{ backgroundImage: 'url("https://themetechmount.com/react/hireco/images/row-bgimage-4.jpg")' }}>
                    ...
                    responsive= { [{ breakpoint: 992, settings: {slidesToShow: 2,slidesToScroll: 2 }},
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style2">
                                ...
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-01-400x480.jpg" alt="blog-image" />
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style2">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="	https://themetechmount.com/react/hireco/images/blog/blog-02-400x480.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style2">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="	https://themetechmount.com/react/hireco/images/blog/blog-03-400x480.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                                            <time className="entry-date" dateTime="2021-04-18T04:16:25+00:00">18 Apr 2020</time>
                                        </span>
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style2">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="	https://themetechmount.com/react/hireco/images/blog/blog-04-400x480.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                                            <time className="entry-date" dateTime="2021-04-18T04:16:25+00:00">18 Apr 2020</time>
                                        </span>
