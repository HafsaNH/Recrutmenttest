                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-post style1">
                                            {/* featured-thumbnail */}
                                            <div className="featured-thumbnail">
                                                <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-05-600x430.jpg" alt="blog-image" />
                                                <div className="ttm-box-post-date">
                                                    <span className="ttm-entry-date">
                                                        <time className="entry-date" dateTime="2021-03-18T04:16:25+00:00">18
                                                        <span className="entry-month entry-year">Mar</span></time>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-post style1">
                                            {/* featured-thumbnail */}
                                            <div className="featured-thumbnail">
                                                <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-06-600x430.jpg" alt="blog-image" />
                                                <div className="ttm-box-post-date">
                                                    <span className="ttm-entry-date">
                                                        <time className="entry-date" dateTime="2021-03-18T04:16:25+00:00">18
                                                        <span className="entry-month entry-year">Mar</span></time>
                                ...
                                <div className="sidebar-right">
                                        ...
                                        <ul>
                                            <li>
                                                <a href={process.env.PUBLIC_URL + '/blog_details'}>
                                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/b_thumbb-01.jpg" alt="post-img"/>
                                                </a>
                                            ...
                                            <li>
                                                <a href={process.env.PUBLIC_URL + '/blog_details'}>
                                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/b_thumbb-02.jpg" alt="post-img"/>
                                                </a>
                                                <div className="post-detail">
                                            ...
                                            <li>
                                                <a href={process.env.PUBLIC_URL + '/blog_details'}>
                                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/b_thumbb-03.jpg" alt="post-img"/>
                                                </a>
                                                <div className="post-detail">
                                    ...
                                    <aside className="widget widget-banner">
                                        <div className="ttm-col-bgcolor-yes bg-theme-DarkColor col-bg-img-seven ttm-col-bgimage-yes ttm-bg p-30 pb-50 pt-45">
                                            <div className="ttm-col-wrapper-bg-layer ttm-bg-layer bg-theme-DarkColor" style={{ backgroundImage: 'url(https://themetechmount.com/react/hireco/images/bg-image/col-bgimage-7.jpg)' }}>
