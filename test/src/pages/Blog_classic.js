                        ...
                        <div className="row">                            
                            <div className="col-lg-8 content-area">
                                ...
                                <article className="post ttm-blog-classic clearfix">
                                    ...
                                    <div className="ttm-post-featured-wrapper ttm-featured-wrapper">
                                        <div className="ttm-post-featured">
                                            <img className="img-fluid" src="	https://themetechmount.com/react/hireco/images/blog/blog-02-1200x800.jpg" alt="blog-img" />
                                            <div className="ttm-box-post-date">
                                                <span className="ttm-entry-date">
                                                    <time className="entry-date">18 Mar 2020</time>
                                                </span>
                                ...
                                <article className="post ttm-blog-classic clearfix">
                                    ...
                                    <div className="ttm-post-featured-wrapper ttm-featured-wrapper">
                                        <div className="ttm-post-featured">
                                            <img className="img-fluid" src="	https://themetechmount.com/react/hireco/images/blog/blog-04-1200x800.jpg" alt="blog-img" />
                                            <div className="ttm-box-post-date">
                                                <span className="ttm-entry-date">
                                                    <time className="entry-date">18 Mar 2020</time>
                                                </span>
                                        ...
                                        <ul>
                                            <li>
                                                <a href={process.env.PUBLIC_URL + '/blog_details'}>
                                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-03-1200x800.jpg" alt="post-img"/>
                                                </a>
