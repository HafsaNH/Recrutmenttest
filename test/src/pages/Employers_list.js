                            ...
                            <div className="col-lg-8 content-area">
                                ...
                                <div className="row">
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-employer">
                                            <div className="featured-thumbnail">
                                                <img src="https://themetechmount.com/react/hireco/images/employer/01.jpg" />
                                            </div>
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-employer">
                                            <div className="featured-thumbnail">
                                                <img src="https://themetechmount.com/react/hireco/images/employer/02.jpg" />
                                            </div>
                                            <div className="featured-content">
                                                <div className="select-btn">
                                                    <i className="fa fa-heart"></i>
                                                ...
                                                <div className="featured-title">
                                                    <h3>Mohamzd bhrori</h3>
                                                </div>
                                                <div className="featured-bottom">
                                                    <div className="job-meta">
                                                        <span><i className="fa fa-map-marker-alt"></i>Agadir Casablanca</span>
                                                        <span><i className="fa fa-hand-holding-usd"></i>$700 - $900/month</span>
                                                        <span>Skills :   HTML, CSS, JavaScript, Wordpress, PHP</span>
                                                    </div>
                                                    <div className="view-block">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-employer">
                                            <div className="featured-thumbnail">
                                                <img src="https://themetechmount.com/react/hireco/images/employer/03.jpg" />
                                            </div>
                                            <div className="featured-content">
                                                <div className="select-btn">
                                                    <i className="fa fa-heart"></i>
                                                ...
                                                <div className="featured-bottom">
                                                    <div className="job-meta">
                                                        <span><i className="fa fa-map-marker-alt"></i>Casablanca , Morocco</span>
                                                        <span><i className="fa fa-hand-holding-usd"></i>$700 - $900/month</span>
                                                        <span>Skills :   HTML, CSS, JavaScript, Wordpress, PHP</span>
                                                    </div>
                                                    <div className="view-block">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div className="featured-imagebox featured-imagebox-employer">
                                            <div className="featured-thumbnail">
                                                <img src="https://themetechmount.com/react/hireco/images/employer/04.jpg" />
                                            </div>
                                            <div className="featured-content">
                                                <div className="select-btn">
                                                    <i className="fa fa-heart"></i>
