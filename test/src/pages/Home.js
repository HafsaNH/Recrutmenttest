            ...
            <div className="col-lg-11">
                ...
                <div className="section-title style2 mb-0">
                    <div className="title-header">
                        ...
                        <h2 className="title">We Understand Your Needs</h2>
                    </div>
                    <div className="title-desc">
                        <p>Our process involves everything from <span className="text-theme-SkinColor">identifying,</span> attracting, shortlisting, interviewing, selecting, hiring, screening, and onboarding employees.</p>
                    </div>
                </div>{/* section title end */}
            </div>
        </div>{/* row end */}
        ...
        <Slider className="row slick_slider slick-arrows-style2 pt-20 mb_10" {...slick_slider} slidesToShow={2} rows={2} arrows={true} autoplay={false} responsive={[{ breakpoint: 1024, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 575, settings: { slidesToShow: 1, slidesToScroll: 1 } }]}>
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    ...
                    <div className="featured-thumbnail">
                        <img src="https://themetechmount.com/react/hireco/images/services/services-01.jpg" alt="Manpower Supply" />
                    ...
                    <div className="featured-content">
                        ...
                        <div className="featured-desc">
                            <p>We specialize in providing quality personnel for all types of recruitment projects.</p>
                        </div>
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    {/* featured-thumbnail */}
                    <div className="featured-thumbnail">
                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/services-02.jpg" alt="Forte Acquisition" />
                    </div>{/* featured-thumbnail end */}
                    <div className="featured-content">
                        <div className="featured-title">
                        ...
                        <div className="featured-desc">
                            <p>We accelerate innovation with current and future-based solutions to support our clients.</p>
                        </div>
                        <a className="ttm-btn btn-inline ttm-btn-size-md ttm-btn-color-darkgrey" href={process.env.PUBLIC_URL + '/services_details'}>Read more!</a>
                    </div>
                </div>{/* featured-imagebox end */}
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    {/* featured-thumbnail */}
                    <div className="featured-thumbnail">
                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/services-03.jpg" alt="Technical Services" />
                    </div>{/* featured-thumbnail end */}
                    <div className="featured-content">
                        <div className="featured-title">
                        ...
                        <div className="featured-desc">
                            <p>We offer a range of technical services, including fabrication, design, and commissioning.</p>
                        </div>
                        <a className="ttm-btn btn-inline ttm-btn-size-md ttm-btn-color-darkgrey" href={process.env.PUBLIC_URL + '/services_details'}>Read more!</a>
                    </div>
                </div>{/* featured-imagebox end */}
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    {/* featured-thumbnail */}
                    <div className="featured-thumbnail">
                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/services-04.jpg" alt="Human Resource" />
                    </div>{/* featured-thumbnail end */}
                    <div className="featured-content">
                        <div className="featured-title">
                        ...
                        <div className="featured-desc">
                            <p>We handle the most challenging tasks in human resources, ensuring deadlines are met.</p>
                        </div>
                        <a className="ttm-btn btn-inline ttm-btn-size-md ttm-btn-color-darkgrey" href={process.env.PUBLIC_URL + '/services_details'}>Read more!</a>
                    </div>
                </div>{/* featured-imagebox end */}
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    {/* featured-thumbnail */}
                    <div className="featured-thumbnail">
                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/services-05.jpg" alt="Executive Search" />
                    </div>{/* featured-thumbnail end */}
                    <div className="featured-content">
                        <div className="featured-title">
                        ...
                        <div className="featured-desc">
                            <p>We specialize in recruiting executives and other key personnel for client companies.</p>
                        </div>
                        <a className="ttm-btn btn-inline ttm-btn-size-md ttm-btn-color-darkgrey" href={process.env.PUBLIC_URL + '/services_details'}>Read more!</a>
                    </div>
                </div>{/* featured-imagebox end */}
            ...
            <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-services style1">
                    {/* featured-thumbnail */}
                    <div className="featured-thumbnail">
                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/services/services-06.jpg" alt="Retained Search" />
                    </div>{/* featured-thumbnail end */}
                    <div className="featured-content">
                        <div className="featured-title">
                        ...
                        <div className="featured-desc">
                            <p>We offer retained search services to enhance innovation and provide solutions for our clients.</p>
                        </div>
                        <a className="ttm-btn btn-inline ttm-btn-size-md ttm-btn-color-darkgrey" href={process.env.PUBLIC_URL + '/services_details'}>Read more!</a>
                    </div>
                </div>{/* featured-imagebox end */}
...
{/* services-section end */}
    ...
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Advanced and expert staffing solutions tailored for Moroccan businesses.</div>
    </li>
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Access to a network of local and international recruiters across Morocco.</div>
    </li>
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Customized recruitment experiences to match the unique needs of Moroccan companies.</div>
    </li>
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Proven strategies that effectively identify and attract top talent in Morocco.</div>
    </li>
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Honest and transparent recruitment process outsourcing for Moroccan firms.</div>
    </li>
    <li><i className="far fa-check-circle"></i>
        <div className="ttm-list-li-content">Innovative methods to connect you with the most suitable candidates in the Moroccan job market.</div>
    </li>
</ul>
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="col-bg-img-one ttm-col-bgimage-yes ttm-bg"  >
                                <div className="ttm-col-wrapper-bg-layer ttm-bg-layer"  style={{ backgroundImage: 'url(https://themetechmount.com/react/hireco/images/bg-image/col-bgimage-2.jpg)' }}></div>
                                <div className="layer-content"></div>
                                <img src="https://themetechmount.com/react/hireco/images/bg-image/col-bgimage-2.jpg" className="img-fluid col-bg-img-res" alt="bgimage" />
                    ...
                    <div className="row g-0">
                        <div className="col-md-6">
                            ...
                            <div className="col-bg-img-two ttm-col-bgimage-yes ttm-bg mt-md-50">
                                <div className="ttm-col-wrapper-bg-layer ttm-bg-layer" style={{ backgroundImage: 'url(https://themetechmount.com/react/hireco/images/bg-image/col-bgimage-1.jpg)' }}></div>
                                <div className="layer-content"></div>
                                <img src="https://themetechmount.com/react/hireco/images/bg-image/col-bgimage-1.jpg" className="img-fluid col-bg-img-res" alt="bgimage" />
                        ...
                        <div className="col-md-6">
                            <div className="pt-70 pt-md-50 pl-70 pl-md-0">
                                ...
                                <div className="section-title">
                                    ...
                                    <div className="title-desc"><p>Recrute has over 3 years experience of Financial, Marketing and Business Solutions 
    ...
    <div className="container">
        ...
        <Slider className="row slick_slider slick-arrows-style1" {...slick_slider} slidesToShow={3} arrows={true}>
            <div className="col-lg-12"> 
                ...
                <div className="testimonials ttm-testimonial-box-view-style1">
                    <div className="testimonial-content">
                        <blockquote className="testimonial-text">Working with the team at Recrute has been incredibly seamless. It's a partnership that's both efficient and enjoyable.</blockquote>
                    ...
                    <div className="testimonial-bottom">
                        <div className="testimonial-avatar">
                            <div className="testimonial-img">
                                <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/testimonial/01.jpg" alt="Alex Jhon Martin" />
                            </div>
                        </div>
            ...
            <div className="col-lg-12"> 
                ...
                <div className="testimonials ttm-testimonial-box-view-style1">
                    <div className="testimonial-content">
                        <blockquote className="testimonial-text">Recrute's commitment to excellence is evident in their approach. Their tagline, 'Expect More, We Do,' truly reflects their service quality.</blockquote>
                        <div className="star-ratings">
                            <ul className="rating">
                                <li className="active"><i className="fa fa-star"></i></li>
                                <li className="active"><i className="fa fa-star"></i></li>
                    ...
                    <div className="testimonial-bottom">
                        <div className="testimonial-avatar">
                            <div className="testimonial-img">
                                <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/testimonial/02.jpg" alt="Michal Wincent" />
                            </div>
                        </div>
                        <div className="testimonial-caption">
                            <label>Manager</label>                                             
            ...
            <div className="col-lg-12"> 
                ...
                <div className="testimonials ttm-testimonial-box-view-style1">
                    <div className="testimonial-content">
                        <blockquote className="testimonial-text">My first experience with a recruiter was exceptional. I couldn't have asked for a better partner in my career journey.</blockquote>
                        <div className="star-ratings">
                            <ul className="rating">
                                <li className="active"><i className="fa fa-star"></i></li>
                                <li className="active"><i className="fa fa-star"></i></li>
                    ...
                    <div className="testimonial-bottom">
                        <div className="testimonial-avatar">
                            <div className="testimonial-img">
                                <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/testimonial/03.jpg" alt="Rayan Methew" />
                            </div>
                        </div>
                        <div className="testimonial-caption">
                            <label>Manager</label>                                             
            ...
            <div className="col-lg-12"> 
                ...
                <div className="testimonials ttm-testimonial-box-view-style1">
                    <div className="testimonial-content">
                        <blockquote className="testimonial-text">The national award-winning staffing agency with the tagline, 'Expect More, We Do,' stands out for its exceptional service.</blockquote>
                        <div className="star-ratings">
                            <ul className="rating">
                                <li className="active"><i className="fa fa-star"></i></li>
                                <li className="active"><i className="fa fa-star"></i></li>
                    ...
                    <div className="testimonial-bottom">
                        <div className="testimonial-avatar">
                            <div className="testimonial-img">
                                <img className="img-fluid" src="https://i.pngimg.me/thumb/f/720/5fb2d39a5a.jpg" alt="Michal Wincent" />
                            </div>
                        </div>
                        <div className="testimonial-caption">
                            <label>Manager</label>                                             
...
{/* testimonial-section end */}
            ...
            {/* aboutus-section */}
            <section className="ttm-row about-section bg-img2 bg-theme-DarkColor ttm-bg ttm-bgimage-yes text-theme-WhiteColor clearfix" style={{ backgroundImage: 'url("https://themetechmount.com/react/hireco/images/bg-image/row-bgimage-2.jpg")' }}>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-8 col-sm-7">
                            <div className="pt-lg-20 pb-30">
                                <p className="text-theme-WhiteColor">We have over 3 years experience of Financial, Musiness Solutions expertise, our goal imize your.</p>
                            </div>
                            {/* ttm-progress-bar */}
                    ...
                    <Slider className="row slick_slider mb_10" {...slick_slider} slidesToShow={3} arrows={false} autoplay={false}>
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style1">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-01-600x430.jpg" alt="blog-image" />
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style1">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-02-600x430.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                                            <time className="entry-date" dateTime="2021-03-18T04:16:25+00:00">18
                                            <span className="entry-month entry-year">Mar</span></time>
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style1">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-03-600x430.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                                            <time className="entry-date" dateTime="2021-03-18T04:16:25+00:00">18
                                            <span className="entry-month entry-year">Mar</span></time>
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="featured-imagebox featured-imagebox-post style1">
                                {/* featured-thumbnail */}
                                <div className="featured-thumbnail">
                                    <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-04-600x430.jpg" alt="blog-image" />
                                    <div className="ttm-box-post-date">
                                        <span className="ttm-entry-date">
                                            <time className="entry-date" dateTime="2021-03-18T04:16:25+00:00">18
                                            <span className="entry-month entry-year">Mar</span></time>
                            ...
                            <div className="d-md-flex align-items-center justify-content-between">
                                ...
                                <div className="featured-icon-box icon-align-before-content style2">
                                    ...
                                    <div className="featured-content">
                                        ...
                                        <div className="featured-desc">
                                            <p>We have over 3 years experience</p>
                                        </div>
                                    </div>
                                </div>{/* featured-icon-box end */}
