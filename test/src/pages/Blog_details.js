                                ...
                                <article className="post ttm-blog-single clearfix">
                                    ...
                                    <div className="ttm-post-featured-wrapper ttm-featured-wrapper">
                                        <div className="ttm-post-featured">
                                            <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/blog/blog-01-1200x800.jpg" alt="blog-img" />
                                        </div>
                                        ...
                                        <div className="ttm-post-entry-header">
                                            <div className="post-meta">
                                                <span className="ttm-meta-line author">
                                                    <img src="https://themetechmount.com/react/hireco/images/blog/b_thumbb-03.jpg" className="img-fluid" height="80" width="80" alt="author"/>By: Edward Samuel
                                                </span>
                                        ...
                                        <div className="entry-content">
                                            <div className="ttm-box-desc-text">
                                                ...
                                                <div className="d-md-flex align-items-center mb-20">
                                                    <img className="img-fluid alignleft" src="https://themetechmount.com/react/hireco/images/blog/b_thumbb-01.jpg
" alt="single-07" />
