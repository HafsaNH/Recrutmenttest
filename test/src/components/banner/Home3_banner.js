        ...
        return (
            ...
            <Slider className="slick_slider banner_slider banner_slider_3" {...slick_slider} slidesToShow={1} autoplay={false} fade="true" >
              <div className="slide bg-layer">
                <div className="slide_img" style={{ backgroundImage: 'url(https://themetechmount.com/react/hireco/images/slides/slider-mainbg-003.jpg)' }}></div>
                            ...
                            <div className="col-lg-6 col-md-8">
                                <div className="slide__content--headings ttm-textcolor-white">
                                    ...
                                    <div className="mt-20 mb-30 mb-md-15">
                                        <p  className="animated animate__fadeInDown">
                            ...
                            <div className="col-lg-6">
                                <div className="d-none d-xl-block text-center position-relative">
                                    <div className="z-index-1 position-relative">
                                      <img  className="rounded-circle box-shadow m-auto img-fuild" src="https://themetechmount.com/react/hireco/images/slides/single-01.jpg"></img>
                                    </div>
                                    <div className="cmp-logo one">
                                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/slides/logo1.png" />
                                    </div>
                                    <div className="cmp-logo two">
                                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/slides/logo2.png" />
                                    </div>
                                    <div className="cmp-logo three">
                                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/slides/logo3.png" />
                                    </div>
                                    <div className="cmp-logo four">
                                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/slides/logo4.png" />
                                    </div>
                                    <div className="cmp-logo five">
                                        <img className="img-fluid" src="https://themetechmount.com/react/hireco/images/slides/logo5.png" />
                                    </div>
                                    <div className="arrow-one">
                                        <img src="https://themetechmount.com/react/hireco/images/slides/arrow-1.png" />
                                    </div>
                                    <div className="arrow-two">
                                        <img src="https://themetechmount.com/react/hireco/images/slides/arrow-2.png" />
                                    </div>
                                </div>
                            </div>
                        </div>
