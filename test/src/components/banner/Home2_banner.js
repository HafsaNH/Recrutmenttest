                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="slide__content--headings ttm-textcolor-white text-center">
                                        <h3 data-animation="animate__fadeInDown">Transforming Careers, Leading Africa.</h3>
                                        <div className="d-flex align-items-center justify-content-center">
                                            <h2 data-animation="animate__fadeInDown">Africa’s Premier Staffing & Job Consultancy</h2>
                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-xl-7 col-lg-8 col-md-10 mx-auto">
                                                    <p data-animation="animate__fadeInDown" className="d-none d-md-block">
                                                        With a new vision and unparalleled expertise, we are setting the benchmark in Africa for job consultancy. Our mission is to connect top talent with leading companies across diverse sectors.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div data-animation="animate__fadeInUp" data-delay="1.4">
                                            ...
                                            href={process.env.PUBLIC_URL + 'job_list'}>Find Your Dream Job!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
